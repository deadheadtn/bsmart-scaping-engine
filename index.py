...
def content():
    ...
    if request.method == "GET":
        ...
        #return render_template('content.html',len=len(listprod),listprod=listprod)
            ...
            jsonprod= {"name": str(prod[0].encode("utf-8")),"reference": prod[1], "image": imaage ,"description": str(prod[3].encode("utf-8")),"providers": str(provider), "category": str(cat),"subcategory": str(subcat)}
            print jsonprod
